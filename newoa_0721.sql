...
INSERT INTO `admin_menu` VALUES (8, 0, 14, '客户管理', 'fa-users', NULL, NULL, '2020-07-20 10:27:13', '2020-07-20 10:45:50');
INSERT INTO `admin_menu` VALUES (9, 8, 15, '客户列表', 'fa-bars', '/customers', NULL, '2020-07-20 10:27:37', '2020-07-20 10:45:50');
INSERT INTO `admin_menu` VALUES (10, 8, 16, '客户需求管理', 'fa-bars', '/customer-demands', NULL, '2020-07-20 10:28:18', '2020-07-20 10:45:50');
INSERT INTO `admin_menu` VALUES (11, 8, 17, '客户联系人管理', 'fa-bars', 'customer-contacts', NULL, '2020-07-20 10:29:01', '2020-07-20 10:45:50');
INSERT INTO `admin_menu` VALUES (12, 0, 8, '综合管理', 'fa-bars', NULL, NULL, '2020-07-20 10:30:26', '2020-07-20 10:45:50');
INSERT INTO `admin_menu` VALUES (13, 12, 10, '渠道管理', 'fa-bars', 'channels', NULL, '2020-07-20 10:42:31', '2020-07-20 10:46:49');
INSERT INTO `admin_menu` VALUES (14, 12, 11, '名片模板管理', 'fa-bars', 'cart-templates', NULL, '2020-07-20 10:42:55', '2020-07-20 10:46:49');
INSERT INTO `admin_menu` VALUES (15, 12, 12, '参数管理', 'fa-bars', 'params', NULL, '2020-07-20 10:43:13', '2020-07-20 10:46:49');
INSERT INTO `admin_menu` VALUES (16, 12, 13, '产品参数管理', 'fa-bars', 'product-params', NULL, '2020-07-20 10:43:30', '2020-07-20 10:46:49');
INSERT INTO `admin_menu` VALUES (17, 12, 9, '部门管理', 'fa-bars', 'departments', NULL, '2020-07-20 10:43:58', '2020-07-20 10:46:49');
INSERT INTO `admin_menu` VALUES (18, 8, 18, '联系人名片管理', 'fa-bars', 'customer-contact-cards', NULL, '2020-07-20 10:44:14', '2020-07-20 10:45:50');
INSERT INTO `admin_menu` VALUES (19, 0, 19, '订单管理', 'fa-bars', NULL, NULL, '2020-07-20 10:44:31', '2020-07-20 10:45:50');
INSERT INTO `admin_menu` VALUES (20, 19, 20, '订单列表', 'fa-bars', 'orders', NULL, '2020-07-20 10:44:53', '2020-07-20 10:45:50');
INSERT INTO `admin_menu` VALUES (21, 19, 21, '订单日志', 'fa-bars', 'orders-logs', NULL, '2020-07-20 10:45:34', '2020-07-20 10:45:50');
INSERT INTO `admin_menu` VALUES (22, 12, 0, '产品管理', 'fa-bars', 'products', NULL, '2020-07-20 11:40:32', '2020-07-20 11:40:32');
...
INSERT INTO `admin_users` VALUES (2, '杨佳敏', '杨佳敏', '$2y$10$7Fn6UC6ZySU4Bmo26tCqs.xpcSJZwaZ.R4MSfYGySOTjEGgI.pwZ6', 1, '17603245687', NULL, 'images/杨佳敏.jpg', '1993年10月13日', 0, 2, '2020年07月20日', NULL, NULL, NULL, '2020-07-20 14:36:49', '2020-07-20 14:36:49', NULL);
...
CREATE TABLE `customer`  (
  ...
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '客户管理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES (1, '测试', 1, '中心场馆', 0, 2, 1, NULL, NULL, 1, 2, '2020-07-20 17:16:55', '2020-07-20 18:24:27', NULL);
...
CREATE TABLE `customer_demand`  (
  ...
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '客户需求表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of customer_demand
-- ----------------------------
INSERT INTO `customer_demand` VALUES (1, 1, '测试', '2020-07-20 18:42:57', '2020-07-20 18:42:57', NULL);
...
CREATE TABLE `department`  (
  ...
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '部门管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `orders`  (
  ...
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '订单管理' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1, '20200720193747696377A50A50C6', 1, '测试', 1, 2, '2020-07-20 19:37:03', '2020-07-20 19:37:03', 1, NULL, NULL, NULL, NULL, NULL, 'files/技术外包客户需求确认表.docx', 0, '2020-07-20 19:37:47', '2020-07-21 11:31:30', NULL);
...
CREATE TABLE `orders_detail`  (
  ...
  `params_id` int(11) NOT NULL COMMENT '参数ID',
...
-- ----------------------------
INSERT INTO `orders_detail` VALUES (1, 1, 3, '标准版', '2020-07-21 12:11:05', '2020-07-21 12:11:05', NULL);
INSERT INTO `orders_detail` VALUES (2, 1, 4, '测试', '2020-07-21 12:11:05', '2020-07-21 12:11:05', NULL);
INSERT INTO `orders_detail` VALUES (3, 1, 5, '是', '2020-07-21 12:11:05', '2020-07-21 12:11:05', NULL);
...
-- ----------------------------
INSERT INTO `orders_status` VALUES (1, 1, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `product_params`  (
  ...
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '产品参数管理' ROW_FORMAT = Dynamic;
...
INSERT INTO `product_params` VALUES (10, 2, 5, '2020-07-20 20:02:07', '2020-07-20 20:02:07');
